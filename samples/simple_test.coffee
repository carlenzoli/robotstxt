...
robotsTxt = require '../index.coffee'
#robotsTxt = require 'robotstxt'
redis = require 'redis'
client = redis.createClient()
#create a new parser
#add some callback action
r = robotsTxt('http://www.google.com/robots.txt', client, "robots", 10, 'Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.iamnnotreallyagooglebot.com/)').on('ready', (gk) ->
