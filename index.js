...
(function() {
  ...
  GateKeeper = (function() {
    function GateKeeper(user_agent) {
      ...
      this.isAllowed = __bind(this.isAllowed, this);
    ...
    GateKeeper.prototype.whatsUp = function(url) {
      ...
      group = this.getGroup();
      return r = this.groups[group].rules.map((function(_this) {
        return function(e) {
          return e(url);
        };
      })(this));
  ...
  RobotsTxt = (function(_super) {
    ...
    function RobotsTxt(url, redis_instance, redis_namespace, redis_key_ttl, user_agent) {
      this.url = url;
      this.redis_instance = redis_instance;
      this.redis_namespace = redis_namespace;
      this.redis_key_ttl = redis_key_ttl;
    ...
    RobotsTxt.prototype.cache_key = function(uri) {
      return "" + this.redis_namespace + ":" + uri;
    };
    ...
    RobotsTxt.prototype.crawl = function(protocol, host, port, path, user_agent, encoding) {
      ...
      req = handler.request(options, (function(_this) {
        return function(res) {
          var _ref;
  ...
  createRobotsTxt = function(url, redis_instance, redis_namespace, redis_key_ttl, user_agent) {
    if (user_agent == null) {
